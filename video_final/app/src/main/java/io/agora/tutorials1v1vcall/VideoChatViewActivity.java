...
public class VideoChatViewActivity extends AppCompatActivity {
        ...
        public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(getApplicationContext(), "等待对方上线", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(getApplicationContext(), "对方已上线", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onUserOffline(final int uid, int reason) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    onRemoteUserLeft();
                    Toast.makeText(getApplicationContext(), "对方已离线", Toast.LENGTH_SHORT).show();
                }
            });
        }
    };
    ...
    private void setupVideoConfig() {
        ...
        mRtcEngine.setBeautyEffectOptions(true, new BeautyOptions(LIGHTENING_CONTRAST_NORMAL, 0.1F, 0.1F, 0.1F));
    }
